diff --git a//dev/null b/src/services/scoringService.test.ts
index 0000000000000000000000000000000000000000..2bb67c8ab28d35535041ac31d8330c6e18dc18be 100644
--- a//dev/null
+++ b/src/services/scoringService.test.ts
@@ -0,0 +1,32 @@
